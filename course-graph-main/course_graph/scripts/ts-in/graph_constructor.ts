...
const FILE_PATH : string = "/Users/janetsong/projects/course_graph/course-graph-main/course_graph/scripts/ts-in/data/graph_data.json"
const CPSC103 : Node = new Course("CPSC_V 103", 4); 
const CPSC107 : Node = new Course("CPSC_V 107", 4); 
const CPSC210 : Node = new Course("CPSC_V 210", 4); 
const CPSC110 : Node = new Course("CPSC_V 110", 4); 
const GRAPH : Graph = new Graph(); 

const JSON_WRITER : JsonWriter = new JsonWriter(FILE_PATH);
